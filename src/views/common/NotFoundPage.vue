          ...
          <b-row class="justify-content-center">
            <b-col xl="5" lg="6" md="6" class="px-5">
              ...
              <p class="text-lead text-white">
                Sepertinya halaman yang Anda cari tidak ditemukan
              </p>
              <router-link to="/login" class="font-weight-bold text-white mt-5"
                >Kembali ke halaman utama</router-link
              >
            </b-col>
          </b-row>
        </div>
    ...
    <section class="py-6 bg-white">
      <b-container>
        <b-row align-v="center" class="row-grid">
          <b-col md="6">
            <b-img src="images/404-bot.jpg" fluid />
          </b-col>
          <b-col md="6">
            <div
              class="pr-md-5"
