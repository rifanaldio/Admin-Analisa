<template xmlns:v-slot="http://www.w3.org/1999/XSL/Transform">
  <div class="w-100 d-flex justify-content-center">
    <div class="text-left w-75 pt-auto mr-auto">
      <h5 class="pt-3 source-sans-pro font-weight-500" v-if="total !== 0">
        Menampilkan {{ startOffset() }} ke {{ endOffset() }} dari
        {{ total }} entri data - Halaman {{ value }}
      </h5>
      <h5 class="pt-3 source-sans-pro font-weight-500" v-else>
